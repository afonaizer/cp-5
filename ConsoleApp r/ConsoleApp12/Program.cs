...
namespace ConsoleApp666
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //if (year % 4 == 0)
            //{
            //    Console.WriteLine($"{year} год явл високосным");
            //}
            //else
            //{
            //    Console.WriteLine($"{year} год не явл вискосным");
            //}
            ////2
            ...
            //{
            //    Console.WriteLine($"{price} руб. входит в диапозон от 20 до 30 тыс. руб.");
            //}
            //else
            //{
            //    Console.WriteLine($"{price} руб. не входит в диапозон от 20 до 30 тыс. руб.");
            //}
            ////3
